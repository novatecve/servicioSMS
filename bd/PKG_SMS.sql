  ...
  PROCEDURE P_INSERTA_CLIENTE(PI_CEDULA    IN CS_EX_CLIENTES.CEDULA%TYPE,
   ...
   PROCEDURE P_INSERTA_ESTATUS_MENSAJE(PI_ID_MENSAJE IN CS_EX_ESTATUS_MENSAJES.ID_MENSAJE%TYPE,
    ...
    BEGIN
     ...
     INSERT INTO CS_EX_ESTATUS_MENSAJES VALUES (vSec,PI_ID_MENSAJE,PI_ID_ESTATUS,PI_FECHA,PI_LOTE);  
  ...
  FUNCTION F_LISTAR_CENTRO_SALUD(PI_ID IN CS_EX_CENTROS_SALUD.ID_CORPORATE%TYPE,
   ...
   IS
    ...
    BEGIN
     ...
     OPEN vCursor FOR                
      SELECT em1.ID,s.ID,s.DESCRIPCION,m.FECHA as FECHA_MENSAJE,em1.FECHA as FECHA_ESTATUS,em1.LOTE,s.CODIGO_PROVEEDOR, c.NOMBRE, c.CELULAR, m.CONTENIDO 
      FROM CS_EX_ESTATUS_MENSAJES em1, CS_EX_ESTATUS s, CS_EX_MENSAJES m,CLIENTES c, CS_EX_TIPOS_MENSAJES tp 
      WHERE em1.ID_ESTATUS = s.ID
        ...
        AND EXISTS (
                ...
                FROM CS_EX_ESTATUS_MENSAJES em 
                WHERE em.ID = em1.ID
