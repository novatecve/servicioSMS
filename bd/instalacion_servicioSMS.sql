...
DECLARE vSec NUMBER := 0;
BEGIN
SELECT SEC_ESTATUS_MENSAJES.NEXTVAL INTO vSec FROM DUAL;
:NEW.id:= vSec;
END;
...
DECLARE vSec NUMBER := 0;
BEGIN
SELECT SMS_TIPO_MENSAJES.NEXTVAL INTO vSec FROM DUAL;
:NEW.id := vSec;
END;
...
DECLARE vSec NUMBER := 0;
BEGIN
SELECT CLIENTES.NEXTVAL INTO vSec FROM DUAL;
:NEW.id := vSec;
END;
...
DECLARE vSec NUMBER := 0;
BEGIN
SELECT PROVEEDORES.NEXTVAL INTO vSec FROM DUAL;
:NEW.id := vSec;
END;
...
DECLARE vSec NUMBER := 0;
BEGIN
SELECT AFILIADOS.NEXTVAL INTO vSec FROM DUAL;
:NEW.id := vSec;
END;
...
DECLARE vSec NUMBER := 0;
BEGIN
SELECT SMS_ESTATUS.NEXTVAL INTO vSec FROM DUAL;
:NEW.id := vSec;
END;
--COMENTARIOS
...
COMMENT ON COLUMN SMS_TIPO_MENSAJES.ID IS 'Identificador del mensaje';
COMMENT ON COLUMN SMS_TIPO_MENSAJES.CONTENIDO IS 'Texto del mensaje';
COMMENT ON COLUMN SMS_TIPO_MENSAJES.ID_AFILIADO IS 'Identificador del aliado comercial al cual pertenece el mensaje';
